...
@section('content')
    <section>
        <div class="sm:w-1/3 sm:px-0 mx-5 sm:mx-auto my-14 border border-black p-5 rounded-lg">
            <h1 class="text-4xl font-semibold text-center">Create New Credential</h1>
            <form action="{{ route('storeCredential') }}" method="post">
                @csrf
                <div class="mt-10">
                ...
                <div class="mt-5">
                    ...
                    <div class="mt-2">
                        <input type="text" name="note" id="note" autocomplete="given-name"
                            class="block px-3 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                
                <div class="mt-10">
                  <button type="submit" class="w-full text-white bg-blue-500 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create</button>
